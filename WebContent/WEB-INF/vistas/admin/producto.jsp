...
<form action="" method="post" class="needs-validation my-3" novalidate>
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<div class="custom-file">
				...
				<label class="custom-file-label" for="imagen" data-browse="Elegir">Seleccionar
					Archivo</label>
	...
	<div class="form-group row">
		...
		<div class="input-group col-sm-10">
			<input type="number" step=".01" class="form-control" id="precio" name="precio" min="0" required>
	...
	<div class="form-group row">
		...
		<div class="input-group col-sm-10">
			<input type="number" step=".01" class="form-control" id="precio-unidad-medida" name="precio-unidad-medida" min="0">
			<div class="input-group-append">
				<span class="input-group-text rounded-right">€</span>
			</div>
